...
<body data-hijacking="on" data-animation="parallax">
	    ...
	    if (array_key_exists("submit", $_POST)) {
	        ...
	        if ($error != "") {
	            ...
	            if (mysqli_num_rows($result1) > 0 || mysqli_num_rows($result2) > 0){
		            ...
		            if (mysqli_num_rows($result) > 0 && $_POST['kiitian']!="NonKIITian") {
		                ...
		                $query = "INSERT INTO `users` (`name`, `rollno`, `university`,`email`, `age`, `gender`, `phone`) VALUES ('".mysqli_real_escape_string($link, $name)."', '".mysqli_real_escape_string($link, $rollno)."', '".mysqli_real_escape_string($link, $university)."', '".mysqli_real_escape_string($link, $email)."', '".mysqli_real_escape_string($link, $_POST['age'])."', '".mysqli_real_escape_string($link, $_POST['gender'])."', '".mysqli_real_escape_string($link, $phone)."')";
		                ...
		                if (!mysqli_query($link, $query)) {
		                	...
		                	$query = "UPDATE `users` SET regid = '".$kritarthID."' WHERE id = ".mysqli_insert_id($link)." LIMIT 1";
	...
	<section class="cd-section visible">
		<div>
			...
			<img class="ksaclogo" src="./ksac.png" alt="logo">
			<video id="videoH" class="hero" muted autoplay preload="auto">
				<source src="./homepage_4.mp4" type="video/mp4">
			</video>
			<video id="videoL" class="heroL" loop muted autoplay preload="auto">
				<source src="./homepage_1.mp4" type="video/mp4">
			</video>

			<img class="name" src="./kritarth.png" alt="logo">
		</div>
	</section>
	...
	<section class="cd-section">
		<div style="position:relative;margin-top:0;">
			<div class="cont">
	    		...
	    		<img src="./event.jpg" alt="event" width="300" height="200">
	...
	<section class="cd-section">
		<div>
	    	...
	    	<h1>Register for Kritarth</h1><p>

	    	<p><strong>Please fill up the following.</strong></p>
			...
			<form class="ajax" method="post">
			    ...
			    <div class="form-group row">
			    	...
			    	<div class="col-sm-7">
			    		<input id="name" name="name" type="text" placeholder="John Doe" class="form-control">
			    	</div>
			    	<span class="col-sm-auto" id="nameStatus" style="display: none;"></span>
			    </div>

			    <!--This not to be passed to the database-->
			    <div class="form-group row">
				    <label for="kiitian" class="col-sm-3 col-form-label">KIITian/non-KIITian</label>
				    <div class="col-sm-7">
					    <select name="kiitian" class="form-control" id="kiitianSelector">
					    	<option value="-1">--Select University--</option>
							<option value="KIITian">KIITian</option>
							<option value="NonKIITian">Non - KIITian</option>
						</select>
					</div>
				</div>

				<!--Toggle between rollno and university-->
			    <div id="KIITian" class="form-group row kiitianSelection" style="display: none;">
			    	<label for="rollno" class="col-sm-3 col-form-label">Roll</label>
			    	<div class="col-sm-7">
			    	<input name="rollno" type="text" class="form-control">
			    	</div>
			    </div>
			    <div id="NonKIITian" class="form-group row kiitianSelection" style="display: none;">
			    	<label for="university" class="col-sm-3 col-form-label">University</label>
			    	<div class="col-sm-7">
			    	<input name="university" type="text" placeholder="Eg.: IIT Bhubaneswar" class="form-control">
			    	</div>
			    </div>
			    ...
			    <div class="form-group row">
			    	...
			    	<div class="col-sm-7">
			    	<input name="email" id="email" type="email" placeholder="johndoe@gmail.com" class="form-control" required>
			    	</div>
			    	<span class="col-sm-auto" id="checkEmail" style="display: none;"></span>
			    </div>

			    <!--Not to be sent to database-->
			    <div class="form-group row">
			    	<label for="datepicker" class="col-sm-3 col-form-label">DOB</label>
			    	<div class="col-sm-7">
			    ...
			    <div class="form-group row">
			    	...
			    	<div class="col-sm-7">
			    	<input id="phone" type="text" name="phone" placeholder="Eg.: 9876543210" class="form-control">
			    	</div>
			    	<span class="col-sm-auto" id="spnPhoneStatus" style="display: none;"></span>
			    </div>
			    <!--
			    <div class="form-group row">
			    	<div class="g-recaptcha col-sm-auto" data-sitekey="6Ld3di8UAAAAAJAG4CLyP1Jo0Ciyj4jbxxWDbWRC"></div>
			    </div>
			    -->

			    <div class="form-group"><input class="btn btn-success" id="submit" name="submit" type="submit" value = "Register!"></div>

			</form>
			<p><a id="showPayNow" href="paywithid.php">Registered already? Pay Now.</a></p>
	    </div>
